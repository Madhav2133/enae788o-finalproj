'''
This script is used to implement the Modified CSA (Information Bias) approach where the agents try to move toawards a target and aim to circle around it.
'''
...
def run_simulation():
    ...
    ax.set_title('CSA with Information Bias')
    ax.set_aspect('equal')
    ...
    for t in range(STEPS):
        ...
        # compute gradient of unexplored map (1 = unexplored)
